...
const localBanners = [
  ...
  require("../assets/banner/banner6.png"),
  require("../assets/banner/banner7.png"),
  require("../assets/banner/banner8.png"),
  require("../assets/banner/banner9.png"),
  require("../assets/banner/banner10.png"),
  require("../assets/banner/banner11.png"),
  require("../assets/banner/banner12.png"),
  require("../assets/banner/banner13.png"),
];
          ...
          <Image
            source={
              course.thumbnail && course.thumbnail.startsWith("http")
                ...
                : localBanners[index % localBanners.length]
            }
            style={styles.image}
            resizeMode="cover"
          />
